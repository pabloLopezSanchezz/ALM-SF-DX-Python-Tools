#!/bin/bash
QUERY_OUTPUT="./acct-scripts/securityChecker/resources/query_output"
USERNAME=$1
PATH_TO_SRC=$2
OUTPUT=$3
PMD=$4
...
sfdx force:data:tree:export --json -d $QUERY_OUTPUT  -u $USERNAME -q "SELECT Assignee.Name, PermissionSet.Name FROM PermissionSetAssignment ORDER BY PermissionSet.Name" > /dev/null
...
echo "$PWD"
ls
python3 ./acct-scripts/securityChecker/securityScanner.py -p $PATH_TO_SRC -r $OUTPUT -pmd $PMD
STATUS=$?
